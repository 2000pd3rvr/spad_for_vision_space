...
def load_material_model(weight_choice=None):
    ...
    # Models directory is sibling to spad_for_vision_space (same level)
    # This file is at: spad_for_vision_space/apps.err/material_detection_naturalobjects/material_detection_functions.py
    # app.py is at: spad_for_vision_space/app.py
    # BASE_DIR = spad_for_vision_space/
    # Models are at: ../models/ (sibling to spad_for_vision_space)
    base_dir = Path(__file__).resolve().parent
    # Go up to spad_for_vision_space, then up one more to parent, then into models/spatiotemporal
    models_dir = base_dir.parent.parent.parent / "models" / "spatiotemporal"
