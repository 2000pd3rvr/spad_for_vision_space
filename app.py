...
def api_flat_surface_detection_weights():
    ...
    try:
        ...
        # Look for weights in models folder
        weights_dir = os.path.join(BASE_DIR, "models", "flat_surface")
...
def api_fluid_purity_weights():
    ...
    try:
        ...
        # Look for weights in models folder
        weights_dir = os.path.join(BASE_DIR, "models", "material_purity")
...
def api_material_detection_head_weights():
    ...
    try:
        ...
        # Look for weights in models folder
        weights_dir = os.path.join(BASE_DIR, "models", "material_detection_head")
...
def api_yolov3_weights():
    ...
    try:
        ...
        weights_dir = os.path.join(BASE_DIR, "models", "yolov3")
...
def api_yolov8_custom_weights():
    ...
    try:
        yolov8_weights = []
        weights_dir = os.path.join(BASE_DIR, "models", "yolov8")
...
def api_dinov3_weights():
    ...
    try:
        ...
        weights_dir = os.path.join(BASE_DIR, "models", "dinov3")
    ...
    try:
        ...
        try:
            ...
            if 'class_names' in ckpt:
                ...
                # If still no class names, use generic names
...
# Map app names to their testimages directories (now in datasets folder)
TESTIMAGES_DIRS = {
    'flat_surface_detection': os.path.join(BASE_DIR, 'datasets', 'testmages__flatsurface'),
    'fluid_purity_demo': os.path.join(BASE_DIR, 'datasets', 'testmages__milkpurity'),
    'dinov3_demo': os.path.join(BASE_DIR, 'datasets', 'testmages_dino'),
    'custom_yolov8_demo': os.path.join(BASE_DIR, 'datasets', 'testmages__yolov8'),
    'spatiotemporal_detection': os.path.join(BASE_DIR, 'datasets', 'testmages_spatiotemporal'),
    'detect_yolov3': os.path.join(BASE_DIR, 'datasets', 'testmages__yolov3'),
    'material_detection_head': os.path.join(BASE_DIR, 'datasets', 'val_natural_material_detection')
}
